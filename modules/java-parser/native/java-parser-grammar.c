...
#line 73 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "y.tab.h".  */
#ifndef YY_DATE_MODULES_JAVA_PARSER_NATIVE_JAVA_PARSER_GRAMMAR_H_INCLUDED
# define YY_DATE_MODULES_JAVA_PARSER_NATIVE_JAVA_PARSER_GRAMMAR_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#line 24 "modules/java-parser/native/java-parser-grammar.y" /* yacc.c:355  */


#include "java-parser-parser.h"


#line 109 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:355  */
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_CLASS_PATH = 10514,
    KW_CLASS_NAME = 10515,
    KW_DATE_OFFSET = 10516,
    KW_DATE_FORMAT = 10517
  };
#endif
/* Tokens.  */
...
#define KW_DATE 10513
#define KW_CLASS_PATH 10514
#define KW_CLASS_NAME 10515
#define KW_DATE_OFFSET 10516
#define KW_DATE_FORMAT 10517
...
#endif /* !YY_DATE_MODULES_JAVA_PARSER_NATIVE_JAVA_PARSER_GRAMMAR_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 446 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:358  */
/* Unqualified %code blocks.  */
#line 30 "modules/java-parser/native/java-parser-grammar.y" /* yacc.c:359  */
...
#line 54 "modules/java-parser/native/java-parser-grammar.y" /* yacc.c:359  */
...
#line 519 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:359  */
...
static const yytype_uint8 yytranslate[] =
{
     ...
     112,   113,   114,   115,   116,   117,   118,     2,     2,     2,
       2,   119,     2,     2,     2,     2,     2,     2,     2,     2,
     120,   121,   122,     2,     2,     2,     2,     2,     2,     2,
     123,   124,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
{
       0,   376,   376,   381,   380,   388,   389,   403,   404,   405,
     406,   630,   631,   689
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_TZ_CONVERT", "KW_TS_FORMAT", "KW_FRAC_DIGITS", "KW_LOG_FIFO_SIZE",
  "KW_LOG_FETCH_LIMIT", "KW_LOG_IW_SIZE", "KW_LOG_PREFIX",
  "KW_PROGRAM_OVERRIDE", "KW_HOST_OVERRIDE", "KW_THROTTLE", "KW_THREADED",
  "KW_FLAGS", "KW_PAD_SIZE", "KW_TIME_ZONE", "KW_RECV_TIME_ZONE",
  "KW_SEND_TIME_ZONE", "KW_LOCAL_TIME_ZONE", "KW_FORMAT", "KW_TIME_REOPEN",
  "KW_TIME_REAP", "KW_TIME_SLEEP", "KW_TMPL_ESCAPE", "KW_OPTIONAL",
  "KW_CREATE_DIRS", "KW_OWNER", "KW_GROUP", "KW_PERM", "KW_DIR_OWNER",
  "KW_DIR_GROUP", "KW_DIR_PERM", "KW_TEMPLATE", "KW_TEMPLATE_ESCAPE",
  ...
  "KW_SCOPE", "KW_SHIFT", "KW_REKEY", "KW_ADD_PREFIX", "KW_REPLACE_PREFIX",
  "KW_ON_ERROR", "KW_RETRIES", "KW_DATE", "KW_CLASS_PATH", "KW_CLASS_NAME",
  "KW_DATE_OFFSET", "KW_DATE_FORMAT", "'('", "')'", "'{'", "'}'", "';'",
  "':'", "$accept", "start", "date_parser", "$@1", "date_parser_options",
  "date_parser_option", "string", "parser_opt", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
   ...
   10090, 10091, 10092, 10093, 10094, 10100, 10110, 10111, 10112, 10120,
   10121, 10130, 10131, 10132, 10140, 10141, 10150, 10151, 10152, 10160,
   ...
   10503, 10504, 10505, 10506, 10507, 10508, 10509, 10510, 10511, 10513,
   10514, 10515, 10516, 10517,    40,    41,   123,   125,    59,    58
};
# endif
...
{
      -4,  -143,     7,  -146,  -147,  -147,  -147,   -89,  -145,  -144,
    -142,  -141,  -140,   -89,  -147,  -127,  -127,  -118,  -127,  -147,
    -147,  -147,  -147,  -139,  -137,  -136,  -135,  -147,  -147,  -147,
    -147
};
...
{
       8,    21,     1,    24,    22,    26,     3,     5,     6,    15,
      16,    25,    17,    18,    20,    19,    27,     9,    28,    29,
...
{
      89,   128,     6,    16,   131,    18,   149,     0,   154,   154,
     154,   129,   154,   154,    13,   155,   155,   106,   155,   155,
...
{
       0,     6,   161,   149,   162,     0,   154,   163,    89,   106,
     152,   153,   164,   165,   167,   154,   154,   154,   154,   155,
     164,   128,   131,   166,   166,   129,   166,   155,   155,   155,
     155
};
...
{
       0,   160,   161,   163,   162,   164,   164,   165,   165,   165,
     165,   166,   166,   167
};
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, CfgLexer *lexer, LogParser **instance, gpointer arg)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, CfgLexer *lexer, LogParser **instance, gpointer arg)
{
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, CfgLexer *lexer, LogParser **instance, gpointer arg)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, CfgLexer *lexer, LogParser **instance, gpointer arg)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (lexer);
...
int
yyparse (CfgLexer *lexer, LogParser **instance, gpointer arg)
{
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 376 "modules/java-parser/native/java-parser-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2796 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 381 "modules/java-parser/native/java-parser-grammar.y" /* yacc.c:1646  */
    {
            last_parser = *instance = date_parser_new (configuration);
          }
#line 2804 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 7:
#line 403 "modules/java-parser/native/java-parser-grammar.y" /* yacc.c:1646  */
    { date_parser_set_offset(last_parser, (yyvsp[-1].num)); }
#line 2810 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 8:
#line 404 "modules/java-parser/native/java-parser-grammar.y" /* yacc.c:1646  */
    { date_parser_set_format(last_parser, (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2816 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 405 "modules/java-parser/native/java-parser-grammar.y" /* yacc.c:1646  */
    { date_parser_set_timezone(last_parser, (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2822 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 13:
#line 689 "modules/java-parser/native/java-parser-grammar.y" /* yacc.c:1646  */
    {
...
#line 2836 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:1646  */
    break;


#line 2840 "modules/java-parser/native/java-parser-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 946 "modules/java-parser/native/java-parser-grammar.y" /* yacc.c:1906  */
